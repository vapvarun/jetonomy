...
### Since you installed, we've shipped several releases
...
- **1.4.0** - Markdown editor, draft autosave, better mention picker, topic templates per space, full accessibility pass on admin screens
- **1.4.1** - Editor polish, stability fixes, RTL improvements
- **1.4.2** - Show & Tell spaces (short-form content feed), Ideas roadmap with real status tracking (Planned / In Progress / Shipped / Declined), Q&A "Answered" badges on space listings, cron batching for large communities, multisite network-activation support, and Pro webhook reliability restored
