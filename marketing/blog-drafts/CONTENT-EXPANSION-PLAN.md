# Jetonomy Network Content Expansion Plan

**Created:** 2026-04-11
**Goal:** Expand network visibility from ~4,450 captured monthly searches to ~8,000+ by targeting untapped keyword clusters.
**Duration:** 4–6 weeks (10–12 new articles)
**Prerequisite data verification:** Ahrefs or Google Keyword Planner access for SaaS-alternatives cluster (optional but strongly recommended).
...
|---|---|---|--:|---|
| wbcomdesigns.com | /bbpress-review/ | bbpress | 2,800 | ✅ |
| vapvarun.com | /forum-wordpress-plugin/ | wordpress forum plugin | 840 | ✅ |
| buddyxtheme.com | /discourse-alternatives-wordpress/ | discourse alternatives | 220 | ✅ |
| attowp.com | /blog/wordpress-community-cms-.../ | community platform | 400 | ✅ |
| bpcustomdev.com | /best-bbpress-alternatives/ | bbpress alternatives | 100 | ✅ |
| tweakswp.com | /best-wpforo-alternatives/ | wpforo alternative | long-tail | ✅ |
| woosellservices.com | /best-forum-software-alternatives/ | forum software alternative | 90+ | ✅ |

**Captured monthly volume: ~4,450+ in exact phrases (more in long-tail).**

---

## Strategic thesis

The existing 7 articles cover **alternative/review/comparison intent** for users who've already decided to leave bbPress/wpForo/Discourse/Circle. That's the bottom-funnel shopper audience.

**What we're missing is the top-of-funnel and long-tail:**

1. **Beginners** who haven't picked a platform yet ("how do I start a community")
2. **bbPress power users** looking to configure/use it better (who we can convert to Jetonomy when they outgrow it)
3. **Private/membership community** operators (high commercial intent)
...
- **Word count:** 2,000
- **Skip if budget tight.** Lower ROI than 1.1–1.3.

**Phase 1 total:** 3–4 articles, ~1,230 monthly search volume captured.
...
- **Structure:**
  ...
  6. Trust level configuration for spam prevention
  7. Moderation workflow for the first 90 days
  8. When to invest in Pro features
...
- **Angle:** Practical migration playbook covering the 3 biggest platform exoduses in 2025-2026:
  ...
  2. Discord → WordPress (monetization concerns, data ownership, SEO exile)
  3. Slack → WordPress (free-tier history limits)
- **Each section:** What triggered the exodus, how to export data, how to import to WordPress, how to communicate the move to existing members, recovery timeline.
- **Jetonomy plug:** Positioned as the WordPress-native destination for all 3 paths. The importer story is central.

**Phase 3 total:** 2 articles, ~150+ monthly volume + significant long-tail.
...
- **Target KW:** broad + head terms (`wordpress community`, `build online community with wordpress`, `wordpress forum guide`)
- **Word count:** 5,000–7,000
- **Format:** Long-form guide that doesn't compete with any specific article. Acts as table of contents with 3-5 paragraph summaries of each sub-topic, then links out to the specific article.
- **Structure:**
  ...
  8. Private/gated communities (links to new private communities listicle)
  9. SaaS vs self-hosted (links to Circle comparison + SaaS alternatives)
  10. FAQ
- **Best created AT THE END** of Phase 1-3 so it has all the children to link to.
- **Expected impact:** Strong topical authority signal. Usually ranks within 6 months. Becomes the top-of-funnel entry point for the whole network.

---

## Site-by-site distribution summary

| Site | Existing articles | New articles (Phase 1-4) | Topical theme |
|---|:-:|:-:|---|
| **wbcomdesigns.com** | 1 | 4 (bbPress shortcodes, bbPress vs BuddyPress, Private community listicle, Circle alternatives) + hub page | bbPress authority + membership |
| **vapvarun.com** | 1 | 1 (Getting Started guide) | Personal dev recommendations + how-to |
| **buddyxtheme.com** | 1 | 0 | Discourse alternatives anchor |
| **attowp.com** | 1 | 2 (WordPress community guide, Skool/Circle/Mighty comparison) | CMS architecture |
| **bpcustomdev.com** | 1 | 2 (Migration playbook, self-hosted Circle alt) | Community migration |
...
| Week | Focus | Articles | Cumulative |
|:-:|---|:-:|:-:|
| 1 | Phase 1 kickoff | 2 (bbPress shortcodes, Tutorial) | 2 |
| 2 | Phase 1 + Phase 2 | 2 (bbPress vs BuddyPress, Getting Started) | 4 |
| 3 | Phase 2 finish + Phase 3 | 2 (WordPress community, Private listicle) | 6 |
| 4 | Phase 3 finish + Phase 4 prep | 2 (Migration playbook, SaaS verification) | 8 |
| 5 | Phase 4 | 2 (Circle alternatives, SaaS comparison) | 10 |
| 6 | Hub page + gap fills | 1 (Hub page) + optional 4.3 | 11–12 |

**Effort per article**: Roughly 30-40 minutes writing + 20 minutes HTML image + 10 minutes publishing/linking = ~1 hour each with my current workflow. 12 articles = ~12 hours distributed over 6 weeks.
...
|---|---|---|
| Combined monthly organic traffic from new articles | Google Analytics | +2,000 sessions/mo |
| Rankings in top 10 (primary KWs) | Google Search Console + SpyFu | 6 of 10 new articles |
| Featured snippets captured | Manual SERP check | 1-2 snippets |
| Jetonomy product page clicks from articles | GA4 event tracking | 100+/mo |
| Cross-site link equity | Ahrefs/SpyFu domain metrics | +5% domain authority on bpcustomdev, tweakswp, woosell |
| Internal link count per article | Manual audit | 6-10 internal links each |

**Leading indicator (30 days):** Pages indexed in GSC, average position in GSC, impressions trending up.

**Lagging indicator (90 days):** Organic clicks, conversion to Jetonomy product page visits, Pro signup attribution.
...
- Each article has a distinct frame and angle (not identical content with swapped URLs)
- Cross-links are natural ("as I wrote about on..."), not stuffed
- Each site maintains its own voice
- Articles pass "would a human write this?" test
...
## Internal linking strategy for Phase 1-5

**Rule:** Every new article must link to at least 5 existing network articles AND receive links from at least 3 existing articles.

Specific link targets by article:

- **Phase 1 articles** (bbPress power-user content) should link to:
  - wbcom /bbpress-review/ (natural anchor: "if you want the honest bbPress verdict")
  - bpcustomdev /best-bbpress-alternatives/ (natural anchor: "when bbPress stops working for you")
  - vapvarun /forum-wordpress-plugin/ (anchor: "wider WordPress forum plugin landscape")
  - Jetonomy product page

- **Phase 2 articles** (Getting Started) should link to:
  - vapvarun /different-types-of-online-communities/ (existing)
  - attowp /wordpress-community-cms-.../ (the architecture piece)
  - wbcom /bbpress-review/ (for the "why not bbPress" question)
  - Jetonomy product page
  - Two Phase 1 articles once they're live

- **Phase 3 articles** (Private/Migration) should link to:
  - bpcustomdev /building-private-communities-when-users-are-leaving-big-platforms/ (existing)
  - wbcom /wordpress-vs-saas-community-platforms/ (existing)
  - buddyxtheme /discourse-alternatives-wordpress/
  - Jetonomy product page
  - Phase 1-2 articles

- **Phase 4 articles** (SaaS alternatives) should link to:
  - wbcom /circle-so-vs-wordpress/ (existing)
  - wbcom /mighty-networks-review.../ (existing)
  - attowp architecture piece
  - Phase 3 articles

- **Hub page (Phase 5)** links to ALL other articles in the cluster. Every other article should add "See the full WordPress Community Guide" link back to the hub.
...
Before each phase begins, confirm with user:
1. **Before Phase 1:** Approve the 3-4 bbPress power-user articles (highest confidence).
2. **Before Phase 4:** Verify SaaS keyword volumes with Ahrefs or approve skipping Phase 4.
3. **Before hub page:** Confirm all Phase 1-3 articles are ranking well enough to warrant the hub investment.

---

## Alternative paths

If you want to go faster and skip the plan:

- **Minimum viable expansion:** Just ship Article 1.1 (bbPress Shortcodes) + Article 2.1 (Getting Started). 2 articles, highest-ROI cluster picks, ~2 hours of work total. Captures 820/mo new keyword volume. Decide on the rest after seeing 30-day ranking data.

- **Maximum aggressive:** Ship all 10+ articles in 1 week. Higher PBN risk but faster impact. Only recommended if you're willing to accept the risk and already have existing content velocity (Wbcom is shipping regularly).
