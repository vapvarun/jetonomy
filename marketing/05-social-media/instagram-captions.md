...
**Slide 1 (Cover):**
Dark background. "Jetonomy 1.0 is live." in large white type. Subtitle: "Modern forums for WordPress. Free." Jetonomy wordmark bottom-left. Clean, typographic, no clutter.
...
Vertical infographic. Title: "How Trust Levels Work in Jetonomy."

Six rows, one per trust level (0–5). Each row:
- Level number (colored circle: grey for 0, green gradient increasing toward 5)
- Level name (Newcomer, Basic, Regular, Leader, Moderator, Trusted Moderator)
- 1-2 key capabilities or restrictions

Key data points to include:
- Level 0: 3 posts/day max, no links
- Level 1: 10 posts/day, links still restricted
- Level 2: Links allowed
- Level 3: Edit freely, follow topics
- Level 4: Moderate content, move posts (manually assigned)
- Level 5: Trusted mod (manually assigned)

Bottom callout: "Levels 0–3 earned automatically. Levels 4–5 assigned by you."

Clean, readable at mobile size. No more than two fonts.
...
Trusted contributors become moderators.
...
Most forum plugins look like they were dropped into your site.

Jetonomy reads your theme's fonts, colors, and spacing automatically.
...
Your support Q&A doesn't have to live in a Facebook group.
...
**Slide 3:**
Icon + name + one-line description for: Analytics Dashboard, Email Digest, Custom Badges. Same card layout.

**Slide 4:**
Icon + name + one-line description for: Advanced Moderation, Webhooks, White Label. Same layout.
...
**Slide 6 (CTA):**
"Free plugin covers everything basic." Line break. "Pro adds the tools for growing communities." Line break. Jetonomy wordmark. "wbcomdesigns.com/jetonomy-pro"

---

### Caption

The free plugin is complete.
