...
**The core plugin is free.** Download it from wbcomdesigns.com. It includes forums, Q&A spaces, ideas boards, voting, trust levels, moderation, full-text search, notifications, SEO markup, 80 REST API endpoints, and built-in importers for bbPress and wpForo.
