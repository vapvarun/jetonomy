...
| Differentiator | What to say | What NOT to say |
|---------------|-------------|-----------------|
...
- 23 custom database tables (not CPTs)
...
- No: revolutionary, game-changing, seamless, leverage, synergy, cutting-edge
- Yes: fast, clean, automatic, built-in, scales, adapts

## CTA Options (by context)

| Context | Primary CTA | Secondary CTA |
|---------|-------------|---------------|
| Landing page | "Download Free" | "See Pro Features" |
| Feature page | "Try It Free" | "View Documentation" |
| Upgrade email | "Upgrade to Pro" | "Compare Free vs Pro" |
| Social post | "Get Jetonomy" | Link to landing page |
| Developer content | "Read the API Docs" | "View on GitHub" |
