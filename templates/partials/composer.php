...
<div class="jt-editor"
	...
	<div class="jt-editor-bar">
		...
		<button type="button" class="jt-editor-bar-btn" data-cmd="image" title="<?php esc_attr_e( 'Upload Image', 'jetonomy' ); ?>">&#128247;</button>
		<button type="button" class="jt-editor-bar-btn" data-cmd="emoji" title="<?php esc_attr_e( 'Emoji', 'jetonomy' ); ?>">&#128522;</button>
	</div>
