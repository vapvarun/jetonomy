...
No join button is shown to non-members. Members can only enter via an invite link generated by a **space admin**.

You can create invite links from either surface:

- **Front-end** - on the space **Members** page (`/community/s/:slug/members/`), the **Invite links** panel generates, copies, and revokes links.
