...
> **Do not edit this file.** It is generated from `audit/manifest.json` by `bin/gen-hooks-reference.php` and regenerated at every release, so it cannot drift from the code. For explanations and copy-paste examples, use the hand-written [Hooks Reference](./02-hooks-reference.md); when the two disagree on names or arguments, THIS file wins.

Plugin version: 2.0.0 - 110 actions, 130 filters.
...
| `jetonomy_join_request_created` | request_id | includes/models/class-join-request.php; includes/models/class-space-member.php (join) |
| `jetonomy_join_request_denied` |  | includes/models/class-join-request.php:115 |
| `jetonomy_media_cleanup_ran` | deleted | includes/class-media-library.php |
| `jetonomy_media_cleanup_reported` | count, ids | includes/class-media-library.php |
...
| `jetonomy_recount_backfill_batch` | 0 args | includes/class-recount-backfill.php:56 |
| `jetonomy_recount_backfill_complete` | none | includes/class-recount-backfill.php (Recount_Backfill::complete) |
...
| `jetonomy_bbpress_import_statuses` | statuses, type | includes/import/class-bbpress-importer.php |
...
| `jetonomy_home_member_hint` | string $hint | templates/views/home.php |
...
| `jetonomy_label` | string $label, string $noun, bool $plural, bool $lower | includes/functions.php |
...
| `jetonomy_media_is_referenced` | $referenced (bool), $attachment_id (int) | includes/class-media-library.php (Media_Library::is_referenced) |
...
| `jetonomy_post_update_has_extension_data` | $has_data (bool, default false), $request (WP_REST_Request), $id (int) | includes/api/class-posts-controller.php (Posts_Controller::update_item) |
...
| `jetonomy_profile_action_url` | url, action, user_id | includes/functions.php |
...
| `jetonomy_spaces_per_page` | int $per_page | templates/views/home.php, templates/views/category.php |
...
| `jetonomy_view_dedupe_cookie` | bool $enabled, int $post_id | includes/class-template-loader.php (Template_Loader::count_view) |
