...
- [Jetonomy vs bbPress](01-vs-bbpress.md) - the modern alternative to the classic WordPress forum
- [Jetonomy vs wpForo](02-vs-wpforo.md) - two custom-table forums, two very different approaches
- [Jetonomy vs Asgaros Forum](04-vs-asgaros.md) - moving up from the lightweight single-developer forum
- [Scalability](03-scalability.md) - how Jetonomy stays fast as your community grows

## What's Next?

- [Installation](../getting-started/01-installation.md) - get Jetonomy running in minutes
- [Feature Overview](../getting-started/00-feature-overview.md) - everything Jetonomy and Jetonomy Pro include
