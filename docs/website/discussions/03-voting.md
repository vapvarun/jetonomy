...
You must be logged in to vote. If you click a vote button while logged out, Jetonomy sends you to the WordPress login page and returns you to the same topic once you sign in.
